...
import express from 'express'; //theo ES6
import connection from './config/database.js';
import { getHomepage } from './controllers/homeController.js';
import cors from 'cors';
import configViewEngine from './config/viewEngine.js';
import apiRoutes from './routes/api.js';
import initProductIndex from './services/esInit.js';
import { reindexAllProducts } from './services/esReindexProducts.js'
...
(async () => {
    try {
        ...
        await connection();
        await initProductIndex(); //khởi tạo index cho product trong ES
        await reindexAllProducts();      //reindex khi start app
